    ...
    <div class="navbar navbar-expand-sm navbar-dark text-black "
     style="height: fit-content; padding:7px; font-size:20px;  ">
        ...
        <div class="container-fluid">
            <a class="navbar-brand text-black" style="font-weight:bold;" ><i class="bi bi-building fa-2x"></i> Recruitment System</a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                      ...
                      <a class="nav-link text-black" style="font-weight:bold;" href="index.html"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
                    </li>
<!-- 
                    <li class="nav-item">
                      <a class="nav-link text-black" style="font-weight:bold;" href="feedback.html"><i class="fa fa-comments" aria-hidden="true"></i> Feedback</a>
                    </li>   -->

                    <li class="nav-item dropdown text-black" style="font-weight:bold;">
                      <a class="nav-link dropdown-toggle text-black" href="#" role="button" data-bs-toggle="dropdown">
                          <i class="bi bi-people"></i>
                          <p class="sr-only"></p>Role
                      </a>
                      <ul class="dropdown-menu ">
                        <li><a class="dropdown-item" style="font-weight:bold;" href="admin.php">HR</a></li>
                        <li><a class="dropdown-item" style="font-weight:bold;" href="intw.php">Interviewer </a></li>
                      </ul>
                    </li>

                    <li class="nav-item">
                      <a class="nav-link text-black" style="font-weight:bold;" href="getstatus.php"><i class="bi bi-journal-text"></i> Check Status</a>
                    </li>  
                </ul>
              </div>
        </div>
...
<div class="col-md-15">
    ...
    <div class="d-flex p-2 bd-highlight ">
        <div class="add" >
			<a href="hrForm.html" name="login" id="add"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Candidates</a>
        </div>
    </div>
...
<?php
include 'mydbCon.php';
$query="select * from candi_info


"; // Fetch all the data from the table candi_info
...
<div class="modal-footer">
          ...
          <button onClick="location.href='schedule_form.html'" type="submit" class="btn btn-default">Schedule</button>
