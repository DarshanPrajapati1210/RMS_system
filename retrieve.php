...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+span" crossorigin="anonymous"/> -->
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item">
                    ...
                    <a class="nav-link text-black" href="index.html"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
                  </li>

                    <!-- <li class="nav-item">
                      <a class="nav-link text-black" href="#"><i class="fa fa-comments" aria-hidden="true"></i> Feedback</a>
                    </li>   -->
...
<div class="d-flex p-2 bd-highlight ">
        <div class="status" >
			<a href="fetch_form.html" ><i class="bi bi-list-check"></i>  Status of Candidates</a>
        </div>
    </div>
<div class="row">
<div class="col-md-15">
...
<?php
include 'mydbCon.php';
$query="select * from schedule limit 200"; // Fetch all the data from the table candi_info
...
<div class="modal-footer">
          ...
          <!-- <button onclick="document.location.href='fetch_form.html';" type="button"
           class="btn btn-default">Status</button> -->
        </div>
</div>
</div>
</div>
